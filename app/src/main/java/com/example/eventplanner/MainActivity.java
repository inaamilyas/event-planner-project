...
import com.example.eventplanner.fragments.BookedVenueFragment;
...
//        buttonCloseDrawer = findViewById(R.id.close_menu);
        ...
        profileImageView = headerView.findViewById(R.id.user_profile_pic_drawer);
        usernameTextView = headerView.findViewById(R.id.user_name_drawer);
        ...
        if (user.getProfilePic() != null) {
            ...
            Glide.with(this).load(imageUrl).placeholder(R.drawable.enent_image).into(profileImageView);
        }
