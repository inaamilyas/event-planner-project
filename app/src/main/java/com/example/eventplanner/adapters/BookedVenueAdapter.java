...
public class BookedVenueAdapter extends RecyclerView.Adapter<BookedVenueAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public BookedVenueAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.booked_venue_item, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BookedVenueAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.btnDeleteOrder = (Button) view.findViewById(R.id.btn_delete_booked_venue);
            this.venueBookedContainer = (LinearLayout) view.findViewById(R.id.booked_venue_view_container);


            this.btnDeleteOrder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    Call<ApiResponse<String>> call = apiService.deleteUserBooking(requestBody);
        ...
        public void setView(BookedVenue bookedVenue) {
            ...
            this.date.setText(bookedVenue.getBookingDate());
